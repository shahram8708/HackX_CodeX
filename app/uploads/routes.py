...
"""
    ...
    try:
        ...
        processor = LlavaProcessor.from_pretrained("llava-hf/llava-interleave-qwen-0.5b-hf", use_fast=True)
        model = LlavaForConditionalGeneration.from_pretrained("llava-hf/llava-interleave-qwen-0.5b-hf", torch_dtype=torch.float32, device_map="cpu")
        ...
        inputs['image_sizes'] = [(image.height, image.width)]
        ...
        current_app.logger.error(f"Local AI model error: {str(e)}")
